...
typedef enum {
	RSCS_BMP280_I2C_ADDR_HIGH 	= 0xEE,
	RSCS_BMP280_I2C_ADDR_LOW 	= 0xED,
} rscs_bmp280_addr_t;
...
int rscs_bmp280_changemode(rscs_bmp280_descriptor_t * bmp, rscs_bmp280_mode_t mode);

//Чтение данных из BMP(в сыром виде)
int rscs_bmp280_read(rscs_bmp280_descriptor_t * bmp, int32_t * rawpress, int32_t * rawtemp);
